...
namespace CoursSessionEtCookieAspNETCore.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IHttpContextAccessor _h)
        {
            httpContext = _h;
        }
        ...
        {
            Personne p = JsonConvert.DeserializeObject<Personne>(httpContext.HttpContext.Session.GetString("personne"));
        ...
        {
            httpContext.HttpContext.Session.SetString("personne", JsonConvert.SerializeObject(p));
